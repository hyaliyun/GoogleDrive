...
- [TypeScript unit tests for component type extensions](https://github.com/hyaliyun/GoogleDrive/core/blob/main/packages/dts-test/componentTypeExtensions.test-d.tsx)
