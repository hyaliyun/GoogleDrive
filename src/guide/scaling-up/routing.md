...
Vue is well-suited for building SPAs. For most SPAs, it's recommended to use the officially-supported [Vue Router library](https://github.com/hyaliyun/GoogleDrive/router). For more details, see Vue Router's [documentation](https://router.vuejs.org/).
